...
namespace Overv {
    public class Block {
        ...
        public const byte portal_air = (byte)120;
        public const byte portal_blue = (byte)121;
        public const byte portal_water = (byte)122;
        public const byte portal_lava = (byte)123;
        ...
        public static string Name( byte type ) {
            switch ( type ) {
                ...
                case 120: return "portal_air";
                case 121: return "portal_blue";
                case 122: return "portal_water";
                case 123: return "portal_lava";
        ...
        public static byte Byte( string type ) {
            switch ( type ) {
                ...
                case "portal_air": return 120;
                case "portal_blue": return 121;
                case "portal_water": return 122;
                case "portal_lava": return 123;
        ...
        public static byte Convert( byte b ) {
            switch ( b ) {
                case 70: return (byte)51; //Flagbase
                ...
                case 120: return air; //portal_air
                case 121: return blue; //portal_blue
                case 122: return waterstill; //portal_water
                case 123: return lavastill; //portal_lava
